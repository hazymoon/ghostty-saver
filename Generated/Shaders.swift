...
// shaders-sha256: c5308ddf750f2a4a7cf77dc7cbb41f353e73bd55a51bec00a4a364dd9c12c5e7
// prefix-ref: v1.3.1
...
void mainImage(thread float4& fragColor, thread const float2& fragCoord, constant Globals& _1400)
{
    ...
    float3 rd = fast::normalize(((forward * 1.25) + (right * ruv.x)) + float3(0.0, ruv.y, 0.0));
    float3 param_16 = ro;
    float3 param_17 = rd;
    int param_18;
    float3 param_19;
    float _1784 = trace(param_16, param_17, param_18, param_19);
    int id = param_18;
    float3 n = param_19;
    float dist = _1784;
    float3 p = ro + (rd * dist);
    ...
    float param_23 = t;
    float3 param_24;
    float3 _1804 = surface(param_20, param_21, param_22, param_23, param_24);
