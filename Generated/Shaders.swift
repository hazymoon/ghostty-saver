...
// shaders-sha256: e2343aa3b4ef49bb717f40f5922cfbd66c1ef1f59c1f7bdf88c8235fe305016a
// prefix-ref: v1.3.1
...
"""#
    ...
    public static let all: [ShaderProgram] = [apollonian, aurora, chladni, contour, gradient, hyperspace, matrix, mode7, moire, mystify, raindrops, saturn, starwars, synthwave, toasters, tunnel]
}
