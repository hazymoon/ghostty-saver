...
// shaders-sha256: d85e516c1108b9c07d74870b135df13496a044ca3161b37ed59611a6b67ac42e
// prefix-ref: v1.3.1
...
void mainImage(thread float4& fragColor, thread const float2& fragCoord, constant Globals& _1400)
{
    ...
    float pitch = (((-0.039999999105930328369140625) + (0.02999999932944774627685546875 * sin((t * 0.699999988079071044921875) + 2.0))) + (0.0199999995529651641845703125 * sin(t * 1.89999997615814208984375))) + ((0.01200000010430812835693359375 * moving) * sin(((s * 2.0) * 6.283185482025146484375) * 2.7999999523162841796875));
    ...
    int param_18;
    float3 param_19;
    float _1787 = trace(param_16, param_17, param_18, param_19);
    int id = param_18;
    float3 n = param_19;
    float dist = _1787;
    float3 p = ro + (rd * dist);
    ...
    float param_23 = t;
    float3 param_24;
    float3 _1807 = surface(param_20, param_21, param_22, param_23, param_24);
