...
// shaders-sha256: dabe523328de07b3112765ef6d9e8941f6aa408846501605d6ba5c1304fdde57
// prefix-ref: v1.3.1
...
void mainImage(thread float4& fragColor, thread const float2& fragCoord, constant Globals& _2084)
{
    ...
    float param = now;
    float t = droppedFrames(param) - (stale / 59.939998626708984375);
    ...
    int param_27;
    float3 param_28;
    float _2637 = trace(param_25, param_26, param_27, param_28);
    int id = param_27;
    float3 n = param_28;
    float dist = _2637;
    float3 p = ro + (rd * dist);
    ...
    float param_32 = t;
    float3 param_33;
    float3 _2657 = surface(param_29, param_30, param_31, param_32, param_33);
