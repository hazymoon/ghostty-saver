...
// shaders-sha256: a2fb82e4158d9e01f2330c9dd05fa410b684837449766439ba03dac3aa2b8854
// prefix-ref: v1.3.1
...
constant spvUnsafeArray<int, 7> _421 = spvUnsafeArray<int, 7>({ -1, 0, 1, 2, 3, -1, 5 });
...
float phaseFor(thread const int& driven, thread const int& driver, thread const float& driverAngle)
{
    ...
    float fi = fract(((alpha - driverAngle) * _248[driver]) / 6.283185482025146484375);
    float fj = 0.5 - fi;
...
"""#
    ...
    public static let all: [ShaderProgram] = [aurora, contour, gears, gradient, hyperspace, matrix, mystify, starwars, synthwave, toasters, tunnel]
}
