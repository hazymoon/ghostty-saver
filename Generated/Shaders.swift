...
// shaders-sha256: 2d5fa3aa3e3d717e6cccb5876550a5e39c91da9fd33ad15c20d30412662a1b4b
// prefix-ref: v1.3.1
...
"""#
    ...
    public static let all: [ShaderProgram] = [apollonian, aurora, chladni, contour, gradient, hyperspace, matrix, mode7, moire, mystify, raindrops, raster, saturn, starwars, synthwave, toasters, tunnel]
}
