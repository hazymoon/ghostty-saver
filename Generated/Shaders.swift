...
// shaders-sha256: 426270d7663b9b8c5b515bfd894ce607b030d95f8209c7ead2cb143c7eaf4103
// prefix-ref: v1.3.1
...
void mainImage(thread float4& fragColor, thread const float2& fragCoord, constant Globals& _3249)
{
    ...
    float2 param_25 = chromaAt + fseed;
    float2 param_26 = (chromaAt + fseed.yx) + float2(7.0);
    float2 blotch = (float2(_noise(param_25), _noise(param_26)) * 2.0) - float2(1.0);
